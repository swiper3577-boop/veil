-------------------------------------------------------------------------------
--! json library + cryptography library (Keep your obfuscated code here)
...
-------------------------------------------------------------------------------
--! Rayfield UI + Key System
local Rayfield = loadstring(game:HttpGet('https://sirius.menu/rayfield'))()
local keyVerified = false

-- Assign onMessage callback
...
KeyTab:CreateParagraph({
    ...
    Content = "1. Click 'Get Key' button\n2. Complete tasks in browser\n3. Copy the key\n4. Paste and click Verify"
})
...
function loadMainScript()
    local MainWindow = Rayfield:CreateWindow({
        Name = "Your Auto System",
        Icon = 0,
        LoadingTitle = "Loading Main Script",
