...
function loadMainScript()
    ...
    MainTab:CreateButton({
        Name = "Feature 1",
        Callback = function()
            Rayfield:Notify({ Title = "Feature 1", Content = "Feature 1 activated!", Duration = 3, Image = 0 })
        end
    })
    ...
    MainTab:CreateButton({
        Name = "Feature 2",
        Callback = function()
            Rayfield:Notify({ Title = "Feature 2", Content = "Feature 2 activated!", Duration = 3, Image = 0 })
        end
    })
    ...
    MainTab:CreateToggle({
        ...
        Callback = function(value)
            if value then
                Rayfield:Notify({ Title = "Auto Farm", Content = "Auto Farm enabled!", Duration = 3, Image = 0 })
                -- start auto farm code
            else
                Rayfield:Notify({ Title = "Auto Farm", Content = "Auto Farm disabled!", Duration = 3, Image = 0 })
                -- stop auto farm code
            end
        end
    })
    ...
    PlayerTab:CreateButton({
        ...
        Callback = function()
            ...
            if plr and plr.Character and plr.Character:FindFirstChildOfClass("Humanoid") then
                ...
                Rayfield:Notify({ Title = "Reset", Content = "Character reset!", Duration = 2, Image = 0 })
            end
        end
    })
    ...
    VisualTab:CreateToggle({
        ...
        Callback = function(value)
            if value then
                Rayfield:Notify({ Title = "ESP", Content = "Player ESP enabled!", Duration = 3, Image = 0 })
            else
                Rayfield:Notify({ Title = "ESP", Content = "Player ESP disabled!", Duration = 3, Image = 0 })
            end
        end
    })
    ...
    VisualTab:CreateSlider({
        ...
        Flag = "FOV",
        Callback = function(value)
            pcall(function() game:GetService("Workspace").CurrentCamera.FieldOfView = value end)
        end
    })
    ...
    TeleportTab:CreateButton({
        ...
        Callback = function()
            ...
            if spawnLocation and hrp then
                pcall(function() hrp.CFrame = spawnLocation.CFrame end)
                Rayfield:Notify({ Title = "Teleported", Content = "Teleported to spawn!", Duration = 2, Image = 0 })
            else
                Rayfield:Notify({ Title = "Error", Content = "Spawn or character not found!", Duration = 3, Image = 0 })
            end
        end
    })
    ...
    TeleportTab:CreateInput({
        ...
        Callback = function(text)
            ...
            local char = plr and plr.Character
            local hrp = char and char:FindFirstChild("HumanoidRootPart")
            if targetPlayer and targetPlayer.Character and hrp and targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
                pcall(function() hrp.CFrame = targetPlayer.Character.HumanoidRootPart.CFrame end)
                Rayfield:Notify({ Title = "Teleported", Content = "Teleported to " .. text, Duration = 2, Image = 0 })
            else
                Rayfield:Notify({ Title = "Error", Content = "Player not found or not spawned!", Duration = 3, Image = 0 })
            end
        end
    })
    ...
    MiscTab:CreateToggle({
        ...
        Callback = function(value)
            ...
            if value then
                ...
                Rayfield:Notify({ Title = "Anti-AFK", Content = "Anti-AFK enabled!", Duration = 3, Image = 0 })
            else
                Rayfield:Notify({ Title = "Anti-AFK", Content = "Anti-AFK disabled!", Duration = 3, Image = 0 })
            end
        end
    })
    ...
    MiscTab:CreateButton({
        ...
        Callback = function()
            ...
            local function TPReturner()
                local ok, SiteJson = pcall(function()
                ...
                if ok and SiteJson and SiteJson.data then
                    for i,v in pairs(SiteJson.data) do
    ...
    Rayfield:Notify({ Title = "Loaded Successfully!", Content = "All features are now available. Enjoy!", Duration = 5, Image = 0 })
end
