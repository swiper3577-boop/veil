...
--! configuration
local service = 11551;  -- your service id, this is used to identify your service.
local secret = "f82a5131-68cc-4978-9c3f-791ad940dd98";  -- make sure to obfuscate this if you want to ensure security.
...
-------------------------------------------------------------------------------
--! Linoria UI Library (More stable alternative)
...
local KeyTab = KeyWindow:AddTab('Key System')

local KeyGroupbox = KeyTab:AddLeftGroupbox('Authentication')

KeyGroupbox:AddLabel('How to Get a Key:')
KeyGroupbox:AddLabel('1. Click Get Key button')
KeyGroupbox:AddLabel('2. Complete tasks in browser')
KeyGroupbox:AddLabel('3. Enter key and verify')
...
KeyGroupbox:AddButton({
    ...
    Func = function()
        copyLink()
        Library:Notify('Link copied to clipboard! Paste in browser.', 5)
    end,
    DoubleClick = false,
    Tooltip = 'Click to copy key link'
})
...
KeyGroupbox:AddButton({
    ...
    Func = function()
        ...
        task.spawn(function()
            ...
            if success then
                keyVerified = true
                Library:Notify('✅ Key verified! Loading script...', 3)
                ...
                Library:Notify('❌ Invalid key. Please try again.', 5)
            end
        end)
    end,
    DoubleClick = false,
...
function loadMainScript()
    ...
    local MainGroupbox = MainTab:AddLeftGroupbox('Features')
    
    MainGroupbox:AddButton({
        Text = 'Feature 1',
        Func = function()
            Library:Notify('Feature 1 activated!', 3)
            -- Add your code here
        end
    })
    ...
    MainGroupbox:AddSlider('WalkSpeed', {
        Text = 'Walk Speed',
        Default = 16,
        Min = 16,
        Max = 200,
    ...
    local PlayerGroupbox = PlayerTab:AddLeftGroupbox('Player Mods')
    ...
    local VisualGroupbox = VisualTab:AddLeftGroupbox('Visual Effects')
    ...
    --! UI Settings
    local MenuGroup = MainTab:AddRightGroupbox('Menu')
    ...
    ThemeManager:SetFolder('YourScriptHub')
